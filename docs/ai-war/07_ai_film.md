---
title: "主題七：AI 影視的路線之爭——2D 生成 vs 3D 世界模擬"
description: "Sora 的退場不代表 AI 影視已死——而是宣告了：靠暴力算力「憑空生成」影片的商業模式，在沒有低成本算力和分發平台的前提下走不通。 AI 影視的未來取決於技術路線選擇、成本結構、和分發管道三者的組合。"
summary: "Sora 的退場不代表 AI 影視已死——而是宣告了：靠暴力算力「憑空生成」影片的商業模式，在沒有低成本算力和分發平台的前提下走不通。 AI 影視的未來取決於技術路線選擇、成本結構、和分發管道三者的組合。"
---
...
**原理：** 先建構一個 3D 虛擬世界（場景、角色、光影、物理規則），再讓 AI 在這個世界裡「拍攝」。本質上是傳統 CG 電影製作流程的 AI 加速版。
...
| | 2D 生成式 | 3D 世界模擬 |
|---|---|---|
| 適合內容 | 短影音、概念展示、社群素材 | 連續劇、動畫、工業級影視 |
...
- 2025 年底 ARR 超過 2.4 億美元，用戶突破 6000 萬
...
中國 AI 短劇《霍去病》在 2025 年兩岸社群瘋傳，號稱：
- 成本 3000 元人民幣
- 兩天製作完成
- 5 億播放量
...
3. **畫面細看之下**，穿著、兵器、建築等細節與歷史嚴重不符
4. 成本 3000 元的說法嚴重低估了前期準備、模型訓練、後期編輯的實際投入
...
| 早期參與《尋龍訣》、《新警察故事》3D 轉製 | ✅ 可追溯 |

### 需要存疑的部分 ⚠️

| 宣稱 | 疑點 |
|---|---|
| 「效率提升 100 倍」「成本降至 1%」 | 全部來自公司單方面說法，無第三方驗證 |
| 「月產可達 1000 部」 | 無獨立產能驗證 |
...
趙天奇不像《霍去病》那樣是明確的數據造假。他更像是**有真實技術基底、但商業宣傳傾向過度包裝**的類型。專利和客戶是真的，但驚人的效率數字在沒有上市作品驗證前，應視為行銷話術。
