...
- Views: 500 million.
Media hailed it as a "landmark event" of AI overturning film.

### Dismantling the Truth
1. **The director later admitted** that most cited figures were exaggerated or rumors.
2. **"500 million views" was likely inflated** by adding all hashtag traffic, not individual episode views.
3. **Upon closer inspection**, details like clothing, weapons, and architecture severely violated historical accuracy.
4. The 3,000 RMB cost significantly underestimated actual prep, model training, and editing labor.
...
1. Microsoft outsourced video AI entirely to OpenAI → Sora got axed → Arsenal returned to zero.
2. Microsoft lacks a consumer entertainment distribution platform (no YouTube/TikTok).
3. Microsoft is a "productivity company," genetically unsuited for pan-entertainment content.
...
1. **Can Afford It:** In-house chips or ultra-low compute costs.
2. **Can Distribute It:** Owned content distribution channels.
3. **Can Verify It:** Works must stand the test of the market, not inflated data.
...
👉 [Theme 08: The Xbox Gamble and Crisis](08_Xbox_Gamble_and_Crisis.md)
