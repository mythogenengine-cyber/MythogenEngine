...
If you only have time for three sections, read: I, VIII, IX.
If you only have time for five sections, add: II, VII.
If you want to read all of it, just read in order.
