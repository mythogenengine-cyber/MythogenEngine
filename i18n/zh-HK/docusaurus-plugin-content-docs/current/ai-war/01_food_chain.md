---
title: "主題一：AI 食物鏈的階級遊戲——誰是地主，誰是租客？"
description: "AI 產業的競爭不是「誰的模型更聰明」，而是誰掌握了結構性的成本優勢與分發管道。理解這個「食物鏈」的階級邏輯，是看懂後續所有主題的基礎。 OpenAI 在 2025 年砍掉了旗下最具話題性的 AI 影片生成產品 Sora，同期年度虧損飆升，Disney 10 億美元合作告吹。"
summary: "AI 產業的競爭不是「誰的模型更聰明」，而是誰掌握了結構性的成本優勢與分發管道。理解這個「食物鏈」的階級邏輯，是看懂後續所有主題的基礎。 OpenAI 在 2025 年砍掉了旗下最具話題性的 AI 影片生成產品 Sora，同期年度虧損飆升，Disney 10 億美元合作告吹。"
---
...
2. **超級分發平台（YouTube + 搜尋）：** Google 擁有全球最大的影片平台 YouTube（月活超 20 億）和搜尋引擎（全球市佔率超 90%）。任何 AI 產品只要整合進這兩個平台，立刻就有幾十億用户的觸達。Google 的 Veo 影片生成工具正在整合進 YouTube Shorts，這是 OpenAI 的 Sora 永遠做不到的事。
...
**獨特的變現邏輯：** 如果 FSD 和 Optimus 真正大規模商用，Tesla 就能把算力成本消化在每一台車和每一個機器人的售價裏。這是理論上最強的「閉環」——但前提是這些產品真的能大規模商業化，目前仍是未知數。
...
但字節跳動有一個 OpenAI 永遠無法擁有的東西：**TikTok / 抖音這個十億級用户的超級分發平台。**

字節跳動的 AI 影片工具 Seedance 2.0 已整合進剪映（CapCut），並在巴西、印尼、墨西哥、菲律賓、泰國、越南等市場開始推出。快手的 Kling 同樣走了「AI + 短影音平台」的路線，截至 2025 年底 ARR 已超過 2.4 億美元，用户突破 6000 萬。

這説明了一件事：**「算得起」和「放得出」，只要佔住其中一項結構性優勢，就有機會活下來。兩項都沒有的，就是 Sora。**
...
👉 [主題二：微軟與 OpenAI 的危險雙人舞](02_ms_openai.md)
